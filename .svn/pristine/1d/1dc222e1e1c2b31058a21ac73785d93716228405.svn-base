...
LOGFILE=$WORKPATH/log/tm_pm_guidurltag.log
...
hive -e "insert overwrite directory '${OUTPUTPATH}/tm_pm_guidurltag' select guid,curltag,count(*),partdate from aotain_dw.tw_fact_useracctag where curltag != '' group by guid,curltag,partdate "  1>>$LOGFILE 2>>$LOGFILE
