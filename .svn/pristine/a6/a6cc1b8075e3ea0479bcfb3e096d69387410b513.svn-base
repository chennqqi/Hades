#!/bin/sh
# ===================================================================================  
# Filename:    szanalysis_v2.0_ctnetusers.sh  
# Revision:    2.0
# Date:        2015/0/06
# Author:      zhengsh
# Description: Analysis of demand in Shenzhen
# Notes:       szanalysis_v2.0_ctnetusers.sh
# ===================================================================================
...
function main()
{
    ...
    # define parameters
    OP_TABLE_NAME=tmp_day_ctnetusers
    ...
    /usr/bin/hive -S -e "use aotain_dw; create table ${OP_TABLE_NAME} as  select distinct userid from tw_static_areauseracc where partdate >= '${OP_SDAY}' and partdate <= '${OP_EDAY}';"
