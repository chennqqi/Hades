...
public class PCAnalysisDriver extends Configured implements Tool {
    public int run(String[] args) throws Exception {                  
        ...
        job.setMapperClass(PCAnalysisMapper.class);
        job.setMapOutputKeyClass(Text.class);
        job.setReducerClass(PCAnalysisReducer.class);
    ...
    public static void main(String[] args)throws Exception{
         int exitcode = ToolRunner.run(new PCAnalysisDriver(), args);
