...
LOGFILE=${WORKPATH}/log/HBase_HTTP_PUSH_PUSHLOG_${CITYNAME}_${DATE}.log
CONFIGPATH=${WORKPATH}/config/

echo `date +"%Y-%m-%d %H:%M:%S"`  "------PUSH_PUSHLOG------------" | tee -a $LOGFILE
...
#HDFS--
DATAPATH=/user/hive/warehouse/broadband.db/ipspush/${CITYNAME}/${DATE}
...
#hadoop jar $JAVALIB/pushlogV2.jar com.aotain.push.PushlogIntoHbase ${DATAPATH} ${CITYNAME}_${DATE} 
hadoop jar $JAVALIB/pushlogV2.jar com.aotain.push.PushlogIntoHbase ${DATAPATH} ${CITYNAME}_${DATE} 1>>$LOGFILE 2>>$LOGFILE
