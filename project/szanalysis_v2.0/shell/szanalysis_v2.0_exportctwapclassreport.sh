#!/bin/sh
# ===================================================================================  
# Filename:    szanalysis_v2.0_exportctwapclassreport.sh
# Revision:    2.0
# Date:        2015/0/06
# Author:      zhengsh
# Description: Analysis of demand in Shenzhen
# Notes:       szanalysis_v2.0_exportctwapclassreport.sh 00 day
# ===================================================================================
...
function main()
{
    ...
    # define parameters    
    OP_EDAY=`date +"%Y%m%d" --date="-5 day"`
    OP_TABLE_NAME=tmp_day_ctwapclass
    FILENAME="CTWAPVisitsClasses_${OP_EDAY}.txt"
    rm -rf ${OUTPUTPATH}/${FILENAME}

    fecho "Gets the ${OP_EDAY} execution log of szanalysis_v2.0_exportctwapclassreport.sh"
