...
public class MBCheckDriver extends Configured implements Tool {
	public int run(String[] args) throws Exception {                  
        ...
        job.setJobName("hdfs mr [" + date + "], TableName:MBCheck" );                    
        job.setJarByClass(getClass());
        job.setMapperClass(MBCheckMapper.class);
        job.setMapOutputKeyClass(Text.class);
        job.setReducerClass(MBCheckReducer.class);
    ...
    public static void main(String[] args)throws Exception{
         int exitcode = ToolRunner.run(new MBCheckDriver(), args);
