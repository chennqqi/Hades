...
//				job.setReducerClass(IdentifierReducerTest.class);
				exists = true;
...
//				job.setReducerClass(IdentifierReducerTest.class);
		...
		MultipleOutputs.addNamedOutput(job, Constant.NAME_OUTPUT_NORMAL, 
				TextOutputFormat.class,Text.class, Text.class);
		MultipleOutputs.addNamedOutput(job, Constant.NAME_OUTPUT_SOURCE, 
				TextOutputFormat.class,Text.class, Text.class);
