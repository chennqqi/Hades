...
public class KVDriver extends Configured implements Tool {
    public int run(String[] args) throws Exception {                  
        ...
        for(int i=0; i<paths.length; i++)
        {
        	...
        	else if(p[1].equals("lzo_deflate"))
        	{
        		MultipleInputs.addInputPath(job,new Path(p[0]),SequenceFileInputFormat.class,KVTextMapper.class);
            	System.out.println("-------------lzo_deflatepaths: "+p[0]);
        	}
        	else
        	{
